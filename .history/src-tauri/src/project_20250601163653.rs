...
pub async fn create_project(
...
) -> Result<ProjectCreatedResponse, String> {
    ...
    let dialog_result = app_handle
        ...
        .blocking_save_file(); // Use blocking version for simplicity in commands // `None` for default starting directory. You could set a PathBuf for a default path.
